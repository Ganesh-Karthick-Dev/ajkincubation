...
const TextTwo = () => {
    ...
    useFrame(() => {
        ...
        const inRange = percent >= 0.73 && percent <= 0.79;
        ...
        switch (animationState.current) {
            ...
            case 'visible':
                if (!inRange) {
                    if (scrollDirection === 'backward' && percent < 0.73) {
                        animationState.current = 'hiding';
                    } else if (scrollDirection === 'forward' && percent > 0.79) {
        ...
        >
            <Center>
                <Text3D
                    ...
                    letterSpacing={0.03}
                >
                    From Idea to Launchpad. Fuel your vision with expert-led incubation and startup essentials.
